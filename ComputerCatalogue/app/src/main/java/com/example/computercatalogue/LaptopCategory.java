...
public class LaptopCategory extends AppCompatActivity {
    ...
    protected static final String LAPTOPCATEGORY_PORTATIL_ASUS_10000_1 = "com.example.computercatalogue.codigo_portatil";
    protected static final String LAPTOPCATEGORY_PORTATIL_THOMSON_10000_2 = "com.example.computercatalogue.codigo_portatil";
    ...
    public void verDetalleAsus(View v) {
        ...
        pantallaDetalleAsus.putExtra(LAPTOPCATEGORY_PORTATIL_ASUS_10000_1, codigoAsus);
    ...
    public void verDetalleThomson(View v) {
        ...
        pantallaDetalleThomson.putExtra(LAPTOPCATEGORY_PORTATIL_THOMSON_10000_2, codigoThomson);
